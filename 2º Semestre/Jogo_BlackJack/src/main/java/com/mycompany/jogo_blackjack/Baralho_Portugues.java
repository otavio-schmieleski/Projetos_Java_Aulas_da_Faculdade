...
public class Baralho_Portugues extends Baralho{
    public void embaralhar(){
        ...
        getCartas().add(new Carta("OUROS","10",1));
        getCartas().add(new Carta("OUROS","Q",10));
        getCartas().add(new Carta("OUROS","J",11));
        getCartas().add(new Carta("OUROS","K",12));
        
        // CARTAS DE ESPADAS
        getCartas().add(new Carta("ESPADAS","1",1));
        getCartas().add(new Carta("ESPADAS","2",2));
        getCartas().add(new Carta("ESPADAS","3",3));
        getCartas().add(new Carta("ESPADAS","4",4));
        getCartas().add(new Carta("ESPADAS","5",5));
        getCartas().add(new Carta("ESPADAS","6",6));
        getCartas().add(new Carta("ESPADAS","7",7));
        getCartas().add(new Carta("ESPADAS","8",8));
        getCartas().add(new Carta("ESPADAS","9",9));
        getCartas().add(new Carta("ESPADAS","10",10));
        getCartas().add(new Carta("ESPADAS","Q",10));
        getCartas().add(new Carta("ESPADAS","J",11));
        getCartas().add(new Carta("ESPADAS","K",12));
        ...
        getCartas().add(new Carta("PAUS","Q",10));
        getCartas().add(new Carta("PAUS","J",11));
        getCartas().add(new Carta("PAUS","K",12));
        ...
        getCartas().add(new Carta("COPAS","Q",10));
        getCartas().add(new Carta("COPAS","J",11));
        getCartas().add(new Carta("COPAS","K",12));
